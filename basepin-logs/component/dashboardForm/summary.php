...
<div class="form-group">
    <label for="terminal-inspected">Total Terminal Inspected:</label>
    <input type="text" id="terminal-inspected" name="terminal-inspected">
</div>

<div class="form-group">
    <label for="total-ok">Total OK:</label>
    <input type="text" id="total-ok" name="total-ok">
</div>

<div class="form-group">
    <label for="total-ng">Total NG:</label>
    <input type="text" id="total-ng" name="total-ng">
</div>
...
<div class="form-group">
    ...
    <div class="status-group" style="margin-top: 5px;">
        <div class="status-item">
            <input type="radio" id="replace_yes" name="replacement_required" value="yes" required>
