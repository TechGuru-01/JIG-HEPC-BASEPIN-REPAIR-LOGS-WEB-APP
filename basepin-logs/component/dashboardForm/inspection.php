...
<div class="checkbox-group full-width">
    ...
    <div class="appearance-row">
        ...
        <div class="action-container">
            <div class="status-group">
                <div class="status-item">
                    <input type="checkbox" id="def_ok" name="deformation_status" value="ok" class="status-check">
                    <label for="def_ok" class="label-ok">OK</label>
                </div>
                <div class="status-item">
                    <input type="checkbox" id="def_ng" name="deformation_status" value="ng" class="status-check">
    ...
    <div class="appearance-row">
        ...
        <div class="action-container">
            <div class="status-group">
                <div class="status-item">
                    <input type="checkbox" id="corr_ok" name="corrosion_status" value="ok" class="status-check">
                    <label for="corr_ok" class="label-ok">OK</label>
                </div>
                <div class="status-item">
                    <input type="checkbox" id="corr_ng" name="corosion_status" value="ng" class="status-check">
    ...
    <div class="appearance-row">
        ...
        <div class="action-container">
            <div class="status-group">
                <div class="status-item">
                    <input type="checkbox" id="mat_ok" name="foreign_material_status" value="ok" class="status-check">
                    <label for="mat_ok" class="label-ok">OK</label>
                </div>
                <div class="status-item">
                    <input type="checkbox" id="mat_ng" name="foreign_material_status" value="ng" class="status-check">
    ...
    <div class="appearance-row">
        ...
        <div class="action-container">
            <div class="status-group">
                <div class="status-item">
                    <input type="checkbox" id="align_ok" name="alignment_status" value="ok" class="status-check">
                    <label for="align_ok" class="label-ok">OK</label>
                </div>
                <div class="status-item">
                    <input type="checkbox" id="align_ng" name="alignment_status" value="ng" class="status-check">
