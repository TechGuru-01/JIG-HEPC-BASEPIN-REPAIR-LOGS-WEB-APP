            ...
            <div class="terminal-inspection-card" style="margin-top: 20px; padding: 15px; border: 1px solid #ddd; border-radius: 8px;">
                ...
                <div class="checkbox-group full-width">
                    <div class="form-group">
                        ...
                        <input type="text" id="no_${i}" name="no[]" value="${rowNumberFormat}"> 
                    </div>
                    <div class="form-group">
...
function generateReplacementRows() {
    ...
    for (let i = currentCount + 1; i <= qty; i++) {
      const rowHTML = `
        ...
        <div class="checkbox-text">
            ...
            <div class="form-group">
                        <label for="terminal_part_no_${i}">Terminal Part No.:</label>
                        <input type="text" id="replacement_terminal_replace_no ${i}" name="replacement_terminal_replace_no[]">
                    </div>
            <div style="padding: 10px 0;">
                <div class="form-group">
                    <label for="reason_replacement_${i}">Reason for Replacement:</label>
                    <input type="text" id="reason_replacement_${i}" name="reason_replacement[]">
                </div>
               
                <div class="form-group">
                    <label for="replacement_technician_${i}">Technician:</label>
                    <input type="text" id="replacement_technician_${i}" name="replacement_technician[]">
                </div>
                <div class="form-group full-width">
                    <label for="change_point_no_${i}">Change Point Control No.:</label>
                    <input type="text" id="change_point_no_${i}" name="change_point_no[]">
                </div>
            </div>
        </div>`;
      container.insertAdjacentHTML("beforeend", rowHTML);
